## R code implementing plotting tasks as part of creating Plot 2
...
## Plot 2 of Global Power against time to window
plot(qdata$Time,qdata$Global_active_power,type="l",xlab="",ylab="Global Active Power (kilowatts)")

## Plot 2 of Global Power against time to png file
