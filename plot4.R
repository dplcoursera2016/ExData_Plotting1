## R code implementing plotting tasks as part of creating Plot 4
...
## Plot 4: 2x2 multiplot  to window
par(mfrow=c(2,2))
plot(qdata$Time,qdata$Global_active_power,xlab="",ylab="Global Active Power",type="l")
plot(qdata$Time,qdata$Voltage,xlab="datetime",ylab="Voltage",type="l")
...
plot(qdata$Time,qdata$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type="l")
